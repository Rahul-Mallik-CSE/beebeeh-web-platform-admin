...
export const productDetailsData: Record<string, ProductDetails> = {
  "1": {
    ...
    installationChecklist: [
      { id: "1", task: "Check power supply", completed: true },
      { id: "2", task: "Install base unit", completed: false },
      { id: "3", task: "Connect refrigerant lines", completed: false },
      { id: "4", task: "Test system", completed: false },
      { id: "5", task: "Final inspection", completed: false },
    ],
    maintenanceChecklist: [
      { id: "1", task: "Clean filters", completed: true },
      { id: "2", task: "Check refrigerant", completed: true },
      { id: "3", task: "Inspect connections", completed: false },
